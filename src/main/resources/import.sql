...
insert into Users(id, name, age, gender) values (1, 'Byka', 23, 'm');
insert into Users(id, name, age, gender) values (2, 'user1', 23, 'm');
insert into Users(id, name, age, gender) values (3, 'user2', 23, 'm');
insert into Users(id, name, age, gender) values (4, 'user3', 23, 'm');
...
insert into Book(id, user_id, name, short_descr, long_descr) values (2, 2, 'Феминистка', 'short descr', 'Фемини́зм (от лат. femina «женщина») — спектр идеологий, политических и социальных движений, направленных на достижение равенства политических, экономических, личных и социальных прав для женщин[1][2] или преодоление сексизма[3].
...
insert into Book(id, user_id, name, short_descr, long_descr) values (4, 4, 'Госопжа', 'short descr', 'ГОСПОЖА
...
insert into Book(id, user_id, name, short_descr, long_descr) values (5, 5, 'Буддист', 'short descr', 'Будди́зм (санскр. बुद्ध धर्म, buddha dharma IAST; пали बुद्ध धम्म, buddha dhamma, «Учение Просветлённого»[1]; кит. 佛教 fójiào) — религиозно-философское учение (дхарма) о духовном пробуждении (бодхи), возникшее в середине 1-го тысячелетия до н. э. в Древней Индии. Основателем учения считается Сиддхартха Гаутама, впоследствии получивший имя Будда Шакьямуни[2].
...
insert into Book(id, user_id, name, short_descr, long_descr) values (6, 5, 'Буддист', 'short descr', 'Будди́зм (санскр. बुद्ध धर्म, buddha dharma IAST; пали बुद्ध धम्म, buddha dhamma, «Учение Просветлённого»[1]; кит. 佛教 fójiào) — религиозно-философское учение (дхарма) о духовном пробуждении (бодхи), возникшее в середине 1-го тысячелетия до н. э. в Древней Индии. Основателем учения считается Сиддхартха Гаутама, впоследствии получивший имя Будда Шакьямуни[2].

Сами последователи этого учения называли его «Дхарма» (Закон, Учение) или «Буддхадхарма» (Учение Будды). Термин «буддизм» был создан европейцами в XIX веке[3]. Различные исследователи определяли буддизм по-разному, — как религию, философию, этическое учение, культурную традицию, цивилизацию, образование[4], как «науку о сознании»[5][6][4].

Буддизм — мировая религия, признанная многочисленными народами с разными традициями. По замечанию Е. А. Торчинова, «Без понимания буддизма невозможно понять и великие культуры Востока — индийскую, китайскую, не говоря уж о культурах Тибета и Монголии, пронизанных духом буддизма до их последних оснований»[3]. ');
insert into Book(id, user_id, name, short_descr, long_descr) values (7, 5, 'Анархист', 'short descr', 'Анархи́зм (от ἀν – без и ἄρχή – власть) — общее наименование ряда систем взглядов, основывающихся на человеческой свободе и отрицающих необходимость управления обществом с помощью государства.[1]
...
insert into Book(id, user_id, name, short_descr, long_descr) values (8, 5, 'Бывшая наркоманка', 'short descr', '«Все утром пили кофе, а мы принимали дозу»: бывшая наркоманка о том, как избавилась от зависимости, живет с ВИЧ и помогает другим бороться
...
insert into Book(id, user_id, name, short_descr, long_descr) values (9, 5, 'Усыновленная', 'short descr', 'сыновле́ние, удочере́ние — форма семейного воспитания детей, лишённых родительской опеки, с установлением между усыновленным и усыновителем правовых (личных и имущественных) отношений, существующих между родителями и детьми[1].
...
insert into Book(id, user_id, name, short_descr, long_descr) values (10, 5, 'Фотограф', 'short descr', 'Фото́граф — человек, создающий фотографии[1][2][3] при помощи фотоаппарата.
...
insert into Book(id, user_id, name, short_descr, long_descr) values (11, 5, 'Бывший заключенный', 'short descr', 'ывший заключенный, который в рамках испытательного срока работал в здании суда в Анкаре, был арестован после того, как в присутствии судьи из его кармана выпали наркотики.
...
insert into Book(id, user_id, name, short_descr, long_descr) values (12, 5, 'Лесби-пара', 'short descr', 'Миранда Хоббс — героиня Синтии Никсон в сериале «Секс в большом городе» — была самой скромной из четверки подруг. А сама актриса пятнадцать лет жила с Дэнни Мозесом, родив с ним двух детей, но потом вдруг променяла его на активистку Кристин Маринони.
